package dev.gaphunter.prometheusmetricnamingcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.prometheusmetricnamingcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.prometheusmetricnamingcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Prometheus Metric Naming Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33794-prometheus-metric-naming-companion/reviews"
